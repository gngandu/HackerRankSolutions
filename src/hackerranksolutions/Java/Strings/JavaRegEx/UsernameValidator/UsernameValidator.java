 ...
 */
package hackerranksolutions.Java.Strings.JavaRegEx.UsernameValidator;
...
public class UsernameValidator {
    ...
    *Each of the next  lines contains a string describing the username. The locked stub code reads the inputs and validates the username.
    *Constraints
