...
public class JavaRegex2DuplicateWords {
    ...
    /*
        ...
        repeated in the sentence I love Love to To tO code. Can you complete the
        ...
        To restore the editor's original stub code, create a new buffer by clicking on the branch 
        ...
        Stub code in the editor prints the sentence modified by the replaceAll line 
        to stdout. The modified string must be a modified version of the initial 
        sentence where all repeat occurrences of each word are removed.
        ...
        We remove the second occurrence of is, the second occurrence of the, and the
        second occurrence of eye from Reya is is the the best player in eye eye game 
        to get Reya is the best player in eye game.
        ...
        It's important to note that our matching is case-insensitive, and we specifically
        retained the first occurrence of the matched word in our final string.
