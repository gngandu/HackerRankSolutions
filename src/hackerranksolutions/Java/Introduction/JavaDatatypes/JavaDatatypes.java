package hackerranksolutions.Java.Introduction.JavaDatatypes;
...
public class JavaDatatypes {
    ...
    and double. For this exercise, we'll work with the primitives used to hold integer
    ...
    capable of properly storing that input. To get you started, a portion of the
    solution is provided for you in the editor.
    ...
    Each test case, , is comprised of a single line with an integer, , which
    can be arbitrarily large or small.
    
    Output Format:
    
    For each input variable  and appropriate primitive , you 
    must determine if the given primitives are capable of storing it. 
    If yes, then print:    
